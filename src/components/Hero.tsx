...
export default function Hero() {
  return (
    <section className="relative w-full bg-[#f8f7f2] pt-8 pb-10 overflow-hidden">
      ...
      <div className="hidden md:block absolute bottom-[-9rem] sm:bottom-[-11.5rem] lg:bottom-[-8rem] xl:bottom-[-6rem] left-[17%] xl:left-[25%] right-0 z-0">
        <Image
      ...
      <div className="block md:hidden w-full flex justify-center">
        <Image
          ...
          width={800}
          height={600}
          className="object-contain w-auto h-auto max-w-md mb-8"
          priority
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-stretch w-full max-w-[2600px] ">
        ...
        <div className="md:w-[50%] xl:w-[60%] 2xl:w-[55%] relative flex flex-col justify-center md:justify-start md:mt-16 md:items-start md:text-left text-left pl-4 md:pl-[9%] 2xl:pl-[13%] mb-8 z-10 sm:mr-10 lg:mr-0">
          ...
          />
          <div className="text-4xl sm:text-3xl lg:text-4xl xl:text-6xl font-extrabold text-[#296d6e] mb-4 text-left w-full lg:w-fit">
            <motion.div
          ...
          <motion.p
            className="text-sm md:text-base text-black/50 w-full lg:w-[65%] leading-relaxed mb-6 "
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.5, delay: 1.3, ease: "easeOut" }}
          >
            a full-stack developer working with Next.js, React Native, and
            Node.js. I love building clean apps and automating workflows with
            CI/CD for smooth, reliable deployments.
          </motion.p>
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-2 border border-[#296d6e]/10 shadow-sm hover:shadow-md transition-all duration-200 group"
              ...
              >
                <i
                  className={`${tech.icon} text-lg opacity-70 group-hover:opacity-100 transition-opacity duration-200`}
                  style={{ color: tech.color }}
                />
                <span className="text-sm font-medium text-[#081b21]/70 group-hover:text-[#296d6e] transition-colors duration-200">
                  {tech.name}
                </span>
              </motion.div>
            ))}
        ...
        <div className="flex flex-col justify-start items-start text-left mt-8 md:mt-8 lg:pl-24 xl:pl-52 pr-8 w-full lg:max-w-sm xl:max-w-xl md:flex-[2] px-4 md:px-0">
          <motion.div
            className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-[#296d6e]/10 shadow-lg"
          ...
          >
            <motion.div
              ...
              transition={{ duration: 1.5, delay: 1.3, ease: "easeOut" }}
            >
              <div className="w-10 h-10 bg-gradient-to-br from-[#296d6e] to-[#1e4d4e] rounded-xl flex items-center justify-center">
                <svg
              ...
              <h2 className="text-[#296d6e] text-lg font-bold">About Me</h2>
            </motion.div>
            <motion.p
              className="text-[#081b21]/70 text-sm leading-relaxed mb-4"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1.5, delay: 1.5, ease: "easeOut" }}
            >
              I&apos;m passionate about clean code, smooth user experiences, and
              automating builds with CI/CD to keep things running fast and
              reliably
            </motion.p>
            <motion.div
              className="flex items-center gap-2 text-xs text-[#296d6e]/60 mb-4"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <h3 className="text-xs lg:text-base font-extrabold tracking-widest text-[#ce6956] mb-4">
              FOLLOW ME
            </h3>
            <div className="flex flex-row gap-4">
              <a
                href="https://github.com/johntetteh090"
                target="_blank"
              ...
              >
                <svg
                  ...
                  className="w-6 h-6 text-[#081b21] hover:text-[#ce6956] transition-colors"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <a
                href="https://www.linkedin.com/in/john-tetteh-22ba11230/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
              >
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.28c-.966 0-1.75-.79-1.75-1.76 0-.97.784-1.76 1.75-1.76s1.75.79 1.75 1.76c0 .97-.784 1.76-1.75 1.76zm13.5 11.28h-3v-5.604c0-1.337-.025-3.063-1.868-3.063-1.868 0-2.154 1.459-2.154 2.968v5.699h-3v-10h2.881v1.367h.041c.401-.761 1.379-1.563 2.841-1.563 3.039 0 3.6 2.001 3.6 4.599v5.597zm0 0" />
                </svg>
              </a>
              <a
